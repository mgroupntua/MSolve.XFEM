...
using MGroup.XFEM.CrackGeometry.Implicit.LevelSetUpdating;
using MGroup.XFEM.CrackGeometry.Implicit.Logging;
using MGroup.XFEM.CrackGeometry.Implicit.MeshInteraction;
...
namespace MGroup.XFEM.CrackGeometry.Implicit
{
    /// <summary>
