...
using MGroup.XFEM.CrackGeometry.Implicit;
using MGroup.XFEM.CrackGeometry.Implicit.Logging;
using MGroup.XFEM.CrackPropagation;
using MGroup.XFEM.CrackPropagation.Direction;
using MGroup.XFEM.CrackPropagation.Jintegral;
using MGroup.XFEM.CrackPropagation.Length;
